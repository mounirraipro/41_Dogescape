...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Dog Escape',
        url: 'https://dogescape.online/about',
        description: 'Learn about Dog Escape, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Dog Escape',
            url: 'https://dogescape.online',
        },
    },
    {
        '@context': 'https://schema.org',
...
export const metadata: Metadata = {
    title: 'About Us – Dog Escape',
    description: 'Learn about Dog Escape, our mission, and the team behind the game.',
    keywords: ['about Dog Escape', 'game team', 'who made Dog Escape'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Dog Escape</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Dog Escape was born from a simple idea: what if playing Dog Escape could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Dog Escape with a clear vision — to create a free, accessible, and
                    ...
                    Dog Escape has something for you.
                </p>
                ...
                <p>
                    Every level in Dog Escape is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Dog Escape offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Dog Escape better for
                    everyone.
                </p>
            </div>
        </>
