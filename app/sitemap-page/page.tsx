...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Dog Escape. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Dog Escape sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Dog Escape' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Dog Escape?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Dog Escape.</p>
                </div>
            </div>
