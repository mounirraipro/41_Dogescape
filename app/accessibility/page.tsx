...
export const metadata: Metadata = {
    ...
    description: 'Dog Escape is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Dog Escape accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Dog Escape accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Dog Escape is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Dog Escape presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Dog Escape. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@dogescape.online</strong></li>
                </ul>
                <p>
