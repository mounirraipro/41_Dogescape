...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Dog Escape puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Dog Escape categories'],
  alternates: {
