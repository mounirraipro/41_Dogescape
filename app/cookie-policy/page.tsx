...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Dog Escape uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Dog Escape cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Dog Escape uses them, and how you can
                ...
                <p>Dog Escape uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Dog Escape.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@dogescape.online</strong>.
                </p>
            </div>
        </>
    );
