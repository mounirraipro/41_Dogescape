...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Dog Escape disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Dog Escape disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Dog Escape (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on dogescape.online
                ...
                <p>
                    Dog Escape is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Dog Escape displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Dog Escape.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Dog Escape is not responsible for any errors
