...
const SITE_URL = 'https://dogescape.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Dog Escape',
        url: SITE_URL,
        description: 'Play Dog Escape free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Dog Escape online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
