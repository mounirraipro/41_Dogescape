...
const SUPPORT_EMAIL = 'hello@dogescape.online';

export const metadata: Metadata = {
    title: 'Contact Dog Escape',
    description: 'Get in touch with the Dog Escape team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Dog Escape', 'Dog Escape support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
